...
class procesar:
    ...
    def retornar_nom(self,qlistas):
        ...
        for doc in self.file_a_terms:
            #obteniendo el documento
            dic_keyscore[doc]=(self.indice)
            #ordenar=doc  
        #ordenar=total_scores.get('new 1.txt')
       # return dic_keyscore   
        #return ordenar
        for docs in self.file_a_terms.keys():#recorriendo las keys de un diccionario
            orden=docs
        #return orden
        #for docu in self.:
